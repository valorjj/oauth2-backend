...
import com.example.oauth2backend.oauth2.domain.social.provider.AuthCodeRequestUrlProvider;
...
public class AuthCodeRequestUrlProviderComposite {
	...
	public AuthCodeRequestUrlProviderComposite(Set<AuthCodeRequestUrlProvider> providers) {
		this.mapping = providers
				.stream()
				.collect(toMap(AuthCodeRequestUrlProvider::getOAuth2ProviderType, identity()));
	}
